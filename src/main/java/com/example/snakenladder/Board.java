        ...
        for(int i=0; i< SnakeLadder.height; i++){
            for(int j=0; j<SnakeLadder.width; j++){
                ...
                if(i%2==0){
                    ...
                    xCord=SnakeLadder.tileSize*SnakeLadder.height-
                            (j*SnakeLadder.tileSize)-SnakeLadder.tileSize/2;
                }
                int yCord=SnakeLadder.tileSize*SnakeLadder.height-
                        (i*SnakeLadder.tileSize)-SnakeLadder.tileSize/2;
